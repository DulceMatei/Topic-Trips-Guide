...
namespace Licenta.Areas.Identity.Pages.Account.Manage
{
    public class DeletePersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "Parola introdusă este incorectă.");
                return Page();
            }

            _context.Recenzii.RemoveRange(_context.Recenzii.Where(r => r.UtilizatorId == user.Id));
            _context.Trasee.RemoveRange(_context.Trasee.Where(t => t.UtilizatorId == user.Id));
            ...
            if (!result.Succeeded)
            {
                throw new InvalidOperationException($"A apărut o eroare neașteptată la ștergerea utilizatorului.");
            }
